			...
			<div class="col-md-offset-1 col-sm-offset-1 col-md-10 col-sm-10 col-xs-12 card">
				...
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2" for="myInput">Arrange by USN:</label>
						<div class="col-md-3 col-sm-3">
							<input type="text" id="myInput2" class="Input" onkeyup="tablefunct('myInput2')">
						</div>
						<label class="control-label col-md-offset-1 col-md-2 col-sm-2" for="myInput">Arrange by date of Publishing:</label>
						<div class="col-md-3 col-sm-3">
							<input type="date" id="myInput3" class="Input" onchange="tablefunct('myInput3')">
						</div>
					</div>
				</form>
				<div class="table-responsive">
					<table id="myTable">
						<tr class="header">
							<th>USN</th>
							<th>Title</th>
							<th>Conferance / Journal Name</th>
							<th>Date of Publishing</th>
							<th>Area</th>
						</tr>
						<?php
							$query="SELECT * FROM pub_details";
