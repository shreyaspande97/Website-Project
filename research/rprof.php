...
<html>
<head>
	<title>Research Head - Research Scholar Details Management</title>
	<meta charset="utf-8">
...
<body onload="openNav()">
	...
	<div class="headerf">
		<div id="mySidenav" class="sidenav" style="height:706px;padding-top:0px;">
			<?php
				include "main.php";
				session_start();
		...
		<ul class="tab col-md-12 col-sm-12 col-xs-12" style="width:100%;">
			...
			<?php
				if($stat)
				{
					...
					echo "<li style='float:right;'><a href = 'hprof.php' class='tablinks' style='cursor:pointer;'>". ($name) ."</a></li>";
					echo "<li style='float:right;'><a href = 'hprof.php' class='tablinks' style='cursor:pointer;'>". ($usn) ."</a></li>";
				}
	...
	<div id="main">
		<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:16px;">
			<h2 class="page-head-line" style="color:black;">Research Head</h2>
				<div class="row">	
					...
					<div class="col-md-offset-1 col-md-5 col-sm-12 col-xs-12">
						<div class="panel" style="font-size:16pt;margin-top:10px;">
							...
							<div class="panel-body">
								...
								?>
								<marquee direction="up" scrollamount="2" style="height:70px;">
									<?php
										$n=1;
					...
					<div class="col-md-offset-1 col-md-5 col-sm-12 col-xs-12" >
						<div class="panel"  style="margin-top:10px;">
							...
							<div class="panel-body">
								<form class="form-horizontal" action="chpass.php" method="POST">
									<div class="form-group">
							...
							<div class="panel-body">
								<form class="form-horizontal" action="uprepno.php" method="POST">
									...
									<div class="form-group">
										...
										<div class="col-md-2 col-sm-2">
											<input type="number" class="form-control" name="rp" value="<?php echo $a['norep'];?>" disabled>
										</div>
									</div>
								</form>
							</div>
