			...
			<div class="col-md-offset-1 col-sm-offset-1 col-md-10 col-sm-10 col-xs-12 card">
				...
				<form class="form-horizontal">
					<div class="form-group">
						<label class="control-label col-md-offset-3 col-md-2 col-sm-2" for="myInput">Arrange by Department:</label>
				...
				<div class="table-responsive">
					<table id="myTable">
						<tr class="header">
							<th style="width:25%;">USN</th>
							<th style="width:25%;">Name</th>
							<th style="width:25%;">Department</th>
							<th style="width:25%;">Year of Joining</th>
						</tr>
						<?php
							$query="SELECT scholar.usn, scholar.name, scholar.dept, rch_details.yearj FROM scholar, rch_details WHERE scholar.usn=rch_details.usn";
