...
<html>
<head>
	<title>Welcome - Research Scholar Details Management</title>
	<meta charset="utf-8">
...
<body>
	<div id="u">Login Unsuccessful!</div>
	<div id="lo">Logout Successful</div>
	<div id="mail">Mail Sent</div>
	<div id="adel">Your account has been deleted</div>
	<div class="headerf">
	...
	<div id="main" onclick="closeNav()">
		<div class="col-md-10 col-sm-10 col-xs-10" style="margin-top:40px;margin-bottom:16px;">
			<div class="col-md-12 col-sm-12 col-xs-12 card">
				<img id="myImg" class="img-responsive" src="img.jpg" alt="Img not found" />
			</div>
			<div class="col-md-12 col-sm-12 col-xs-12 card" style="margin-top:40px;">
				<div class="col-md-12">
					<h4 class="page-head-line">Welcome</h4>
				</div>	
				<div style="font-size:16pt;font-family:'Times New Roman';margin:15px;text-indent:2cm;">
					This is the homepage of research scholars of the Computer Science and Engineering department of BMS College of Engineering, Bengaluru. The department has a large number of people enrolled in research programmes.
				</div>
			</div>
		</div>
		<div class="col-md-2 col-sm-2 col-xs-2" style="margin-top:40px;margin-bottom:16px;">
			<div data-toggle="modal" data-target="#notic" class="col-md-12 col-sm-12 col-xs-12" style="cursor:pointer;">
				<div class="panel panel-primary" style="font-size:16pt;">
					<div class="panel-heading">News / Notice</div>
					<div class="panel-body">
						<?php
							$query = "SELECT updt FROM `updts`";
							$res = mysqli_query($dbhandle,$query);
						?>
						<marquee direction="up" scrollamount="2" style="height:160px;">
							<?php
								$n=1;
								while($rl = mysqli_fetch_assoc($res))
								{
									echo "<div style='text-align:justify;'>";
									echo "<span style='font-size:12pt;font-family: Arial;'>".$n++.") ".$rl['updt']."</span></div>";
								}
							?>
						</marquee>
					</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:20px;font-size:16pt;">
				<div class="panel panel-primary">
					<div class="panel-heading">Quick Links</div>
					<div class="panel-body">
						<ul>
							<li><div class="panel-dets"><a href="http://bmsce.ac.in">BMSCE</a></div></li>
							<li><div class="panel-dets"><a href="http://bmsce.ac.in/department/computer-science-and-engineering">CSE Dept.</a></div></li>
							<li><div class="panel-dets"><a href="http://bmsce.ac.in/teqip-i">TEQUIP</a></div></li>
							<li><div class="panel-dets"><a href="http://bmsce.ac.in/principals-desk">Principal's Desk</a></div></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<div class="modal fade" id="notic" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h3 class="modal-title">NEWS / NOTICE</h3>
				</div>
				<div class="modal-body">
					<?php
						$query = "SELECT updt FROM `updts`";
						...
						$n=1;
						while($rl = mysqli_fetch_assoc($res))
							echo "<div style='text-align:justify;font-size:12pt;font-family: Arial;border:0.5px solid black;text-indent:30px;margin-bottom:10px;padding:10px;'>".$n++.") ".$rl['updt']."</div>";
					?>
				</div>
			</div>
		</div>
